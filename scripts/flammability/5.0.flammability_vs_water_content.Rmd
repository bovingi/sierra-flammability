...
tti_plot_lfm_r_spp <- mem_data_all_r %>%
  ...
  labs(x = "", 
       y = "Time to Ignition (s)") +
  annotate(geom = "text", x = -2.3, y = 230, label = 'a', fontface = 'bold', size = 10)
tti_plot_lfm_r_spp
```
...
fh_plot_r_spp <- mem_data_all_r %>% 
  ...
  labs(x = "", 
       y = "Flame Height (cm)") +
  annotate(geom = "text", x = -2.9, y = 55, label = 'b', fontface = 'bold', size = 10)
fh_plot_r_spp
...
lower_temp_max_plot_r_spp <- mem_data_all_r %>% 
  ...
  labs(x = "", 
       y = "Maximum Temperature") +
  annotate(geom = "text", x = -2.9, y = 500, label = 'd', fontface = 'bold', size = 10)
...
lower_temp_max_plot_lfm_r_spp <- mem_data_all_r %>%
  ...
  labs(x = "", 
       y = "Maximum Temperature") +
  annotate(geom = "text", x = -2.3, y = 500, label = 'd', fontface = 'bold', size = 10)
...
gd_plot_lfm_r_spp <- mem_data_all_r %>%
  ...
  labs(x = "Live Fuel Moisture (scaled)", 
       y = "Glow Duration (s)") +
  annotate(geom = "text", x = -2.3, y = 400, label = 'e', fontface = 'bold', size = 10)
gd_plot_lfm_r_spp
```
...
temp_change_plot_lfm_r_spp <- mem_data_all_r %>%
  ...
  labs(x = "", 
       y = "Temperature Change (C)") +
  annotate(geom = "text", x = -2.3, y = 220, label = 'c', fontface = 'bold', size = 10)
