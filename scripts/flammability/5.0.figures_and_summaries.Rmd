...
spp_estimates <- tidy_data  %>% 
  ...
  geom_point(aes(x = estimate,y = species), size =2) +
    geom_point(aes(x = upr, y = species), size = .5) +
  geom_point(aes(x = lwr, y = species), size = .5) +
...
ggsave(plot=spp_estimates, bg = "white" , here::here("figures", "spp_estimates_flam_metrics.jpeg"), device="jpg")
```
