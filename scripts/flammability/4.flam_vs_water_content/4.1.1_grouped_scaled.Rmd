...
```{r}
mem_data_all_raw <- read_csv(here("processed-data", "sierra_flam_data_all.csv")) %>% 
...
field_data_all <- read_csv(here("processed-data", "field_data_2020_2021.csv"))
```
...
temp_max.ES.lfm <- c(0.13, 3.3, 9.9, 5, -19) # Following this order: ABCO, CADE, PIJE, ARPA, QUKE
temp_max.SE.lfm <- c(5.4192, 10.0238, 7.6785, 8.1860, 13.8426)
temp_max.sig.lfm <- c('No', 'No', 'No', 'Yes', 'No')
temp_max.ES.mpa <- c(1.5, -1.1, -15, 17, 19)
temp_max.SE.mpa <- c(5.5976, 9.6061, 7.8172, 8.2544, 14.1627)
...
ggsave(plot = main_figure, bg = 'white', 
       here("figures", "extra-figures", "Grouped.and.Scaled.Flam.vs.Hydration.jpg"),
       width = 16, height = 10)
```
