...
ggsave(here('figures', 'extra-figures', 'spp_flam_metrics.jpeg'), plot = both_spp_plots_w_legend, height = 15, width = 15)
```
...
mem.table.df %>%
  ...
  save_kable(here('figures', 'supp-figures', 'TableSX.MEM_results.html'))
```
...
mem.table.df %>%
  ...
  save_kable(here('figures', 'MEM_figures', 'Functional_Group_MEM_Table.html'))
```
