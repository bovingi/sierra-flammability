...
mem_data_all_r <- mem_data_all%>% drop_na(mpa, lfm, sample_wt)
...
ggsave(plot=plots_legend, bg = "white" , here::here("figures", "mpa_flam_metrics_withceco_unscaled"), device="jpg")
```
...
ggsave(plot=plots_legend, bg = "white" , here::here("figures", "lfm_flam_metrics_withceco_unscaled"), device="jpg")
```
...
ggsave(plot=spp_estimates, bg = "white" , here::here("figures", "spp_estimates_flam_metrics_withceco_unscaled"), device="jpg")
```
