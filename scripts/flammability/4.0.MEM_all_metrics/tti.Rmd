...
#   save_kable(here('figures', 'MEM_figures', 'Main_MEM_Selection_kable_tti.html'))
```
...
#   string.p = "P-Value", 
#   p.style = "stars",
#   file = here('figures', 'MEM_figures','tti_by_spp_tti.html')) # saving _tti.html into figures folder
# ```
# 
# ## Time to Ignition
# ```{r}
...
#   string.p = "P-Value", 
#   p.style = "stars",
#   file = here('figures', 'MEM_figures','FD_by_spp_tti.html')) # saving _tti.html into figures folder
# ```
# 
# ## Glow Duration
# ```{r}
...
#   string.p = "P-Value", 
#   p.style = "stars",
#   file = here('figures', 'MEM_figures','GD_by_spp_tti.html')) # saving _html into figures folder
# ```
# 
# ## SUPP: Kable Table
# ```{r}
...
#   save_kable(here('figures', 'supp-figures', 'Supp_spp_Split_MEM_kable_tti.html'))
```
...
tab_model(m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','fh_tti.html')) # saving _tti.html into figures folder
```
# -----------------------------------
# Visualizations
## Dry Weight Effect
...
https://strengejacke.github.io/sjPlot/articles/tab_model_estimates_tti.html 
##### Tables
```{r}
tab_model(mpa_mod_fig.mpa, m11, m7, m10, m3, m6, m6.5, m12, m15,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM_figures','site.yearmonth.samplewt')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM_figures','mem_TTI_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM_figures','mem.FH_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures','MEM_figures','mem.GD_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','mem.FD_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','mem.MAXTEMP_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','mem.PFG_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','mem.TTFG_tti.html')) # saving _tti.html into figures folder
```
...
tab_model(m1, m2, m3, m4, m5,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','mem.GTI_tti.html')) # saving _tti.html into figures folder
```
...
mem.table2.df %>%
  ...
  save_kable(here('figures', 'main-figures', 'Table2_MEM_kable_tti.html'))
```
...
mem.table.df %>%
  ...
  row_spec(c(1, 7, 13, 19), background = "#D3D3D3", bold = T, font_size = 16) %>% 
  row_spec(c(2, 8, 14, 15, 16, 20), bold = T) %>% 
  save_kable(here('figures', 'extra-figures', 'expanded_MEM_kable_tti.html'))
```
...
shortened.table.df %>%
  ...
  kable_styling(bootstrap_options = c('hover', 'bordered', 'condensed'), fixed_thead = T) %>% 
  save_kable(here('figures', 'extra-figures', 'shortened_MEM_kable_tti.html'))
```
...
tab_model(m1, m2, m3, m4, m5, m6, m7, m8,
  ...
  string.p = "P-Value", 
  p.style = "stars",
  file = here('figures', 'MEM_figures','excess.dry.weight_tti.html')) # saving _tti.html into figures folder
```
