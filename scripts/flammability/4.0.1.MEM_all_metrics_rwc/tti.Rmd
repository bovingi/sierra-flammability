...
AIC(sw_m10)
performanace::multicollinearity(sw_m10)
...
```{r}
max_model_nompa <- lmer(tti ~ spp + dw_flam_sample_scaled +  ww_flam_sample_scaled +  rwc+ excess_water_scaled + site +  year_month + (1 | individual), data = mem_data_all)
