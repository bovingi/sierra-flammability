...
# fxn <- function(x) {
#   assign(paste0(x$spp,"_mean_mpa"), x$mean_mpa, envir = .GlobalEnv)
#   assign(paste0(x$spp,"_upper_mpa"), x$upper_mpa, envir = .GlobalEnv)
#   assign(paste0(x$spp,"_lower_mpa"), x$lower_mpa, envir = .GlobalEnv)
#   assign(paste0(x$spp,"_mean_lfm"), x$mean_lfm, envir = .GlobalEnv)
#   assign(paste0(x$spp,"_upper_lfm"), x$upper_lfm, envir = .GlobalEnv)
#   assign(paste0(x$spp,"_lower_lfm"), x$lower_lfm, envir = .GlobalEnv)
# }
# 
# fxn(pv_means)
```
