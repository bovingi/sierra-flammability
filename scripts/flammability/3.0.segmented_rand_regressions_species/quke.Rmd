...
o_mod<-lme(tti~ mpa, random=~1|id, data=quke_subset_seg_tti)
...
u_mod <- lm(tti~mpa, data = quke_subset_seg_tti)
...
o_mod<-lme(fh~mpa, random=~1|id, data=quke_subset_seg_fh)
...
u_mod <- lm(fh~mpa, data = quke_subset_seg_fh)
u_mod_b <- segmented(u_mod, ~mpa)
summary.segmented(u_mod_b)
...
o_mod<-lme(fd~mpa, random=~1|id, data=quke_subset_seg_fd)
os_mod <-segmented.default(o_mod, ~mpa, npsi=list(mpa=1))
#summarizing results (note the '_coef' argument)
summary.segmented(os_mod)
...
u_mod <- lm(fd~mpa, data = quke_subset_seg_fd)
u_mod_b <- segmented(u_mod, ~mpa)
summary.segmented(u_mod_b)
...
o_mod<-lme(gd~mpa, random=~1|id, data=quke_subset_seg_gd)
os_mod <-segmented.default(o_mod, ~mpa, npsi=list(mpa=1))
#summarizing results (note the '_coef' argument)
summary.segmented(os_mod)
...
u_mod <- lm(gd~mpa, data = quke_subset_seg_gd)
u_mod_b <- segmented(u_mod, ~mpa)
summary.segmented(u_mod_b)
...
o_mod<-lme(prop_ignite~mpa, random=~1|id, quke_subset_seg_prop_ignite )
os_mod<-segmented.default(o_mod, ~mpa, npsi=list(mpa=1))
#summarizing results (note the '_coef' argument)
summary.segmented(os_mod)
...
u_mod <- lm(prop_ignite~mpa, data = quke_subset_seg_prop_ignite)
u_mod_b <- segmented(u_mod, ~mpa)
summary.segmented(u_mod_b)
...
<!-- o_mod<-lme(gti~mpa, random=~1|id, data=quke_subset_seg_gti) -->
<!-- os_mod<-segmented.default(o_mod, ~mpa, npsi=list(mpa=1)) -->
<!-- #summarizing results (note the '_coef' argument) -->
<!-- summary.segmented(os_mod) -->
...
<!-- o_mod<-lme(lower_temp_max~mpa, random=~1|id, data=quke_subset_seg_lower_temp_max) -->
<!-- os_mod<-segmented.default(o_mod, ~mpa, npsi=list(mpa=1)) -->
<!-- #summarizing results (note the '_coef' argument) -->
<!-- summary.segmented(os_mod) -->
<!-- os_mod -->
...
o_mod<-lme(lower_temp_max~mpa, random=~1|id, data=quke_subset_seg_temp_change)
os_mod<-segmented.default(o_mod, ~mpa, npsi=list(mpa=1))
#summarizing results (note the '_coef' argument)
summary.segmented(os_mod)
os_mod
...
u_mod <- lm(temp_change~mpa, data = quke_subset_seg_temp_change)
u_mod_b <- segmented(u_mod, ~mpa)
summary.segmented(u_mod_b)
