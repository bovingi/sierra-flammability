---
title: "abco segmented regressions: rwc"
...
rsegplot.rwc(os_mod_b, abco_subset_seg_tti, max.x = abco_max_rwc, y.variable = 'tti', y.lab = "Time to Ignition (s)")
```
...
rsegplot.rwc(os_mod, abco_subset_seg_fh, max.x = abco_max_rwc, y.variable = 'fh', y.lab = "Flame Height (cm)")
```
...
rsegplot.rwc(os_mod, abco_subset_seg_fd, max.x = abco_max_rwc, y.variable = 'fd', y.lab = "Flame Duration (s)")
```
...
rsegplot.rwc(os_mod, abco_subset_seg_gd, max.x = abco_max_rwc, y.variable = 'gd', y.lab = "Glow Duration (s)")
```
...
rsegplot.rwc(os_mod, abco_subset_seg_prop_ignite, max.x = abco_max_rwc, y.variable = 'prop_ignite', y.lab = "Proportion Ignted (5% Bins of rwc)")
```
...
rsegplot.rwc(os_mod, abco_subset_seg_temp_change, max.x = abco_max_rwc, y.variable = 'temp_change', y.lab = "Temp Change (C)")
```
# Final Table 
