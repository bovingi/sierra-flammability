...
```{r}
a <- c(12,20,22,21,1,2,5,6,0.2,12,3,25)
b <- c(1,5,9,22,10,16,0.2,9,20,3,3,12.5)
c <- c(rep(c("abco", "ceco", "cade", "pije"), 3))
d <- c(rep(c('y', '0', '0', '0'), 3))
test.df <- data.frame(a,b,c,d)

ggplot(test.df, aes(x = a, y = b, group = c)) +
  geom_point(aes(color = c)) +
  geom_smooth(method = 'lm', se = F, aes(linetype = d, color = c)) +
  theme_bw()
```
...
mem_data_all_r <- mem_data_all%>% drop_na(mpa_scaled, lfm_scaled, sample_wt_scaled)
...
tti_plot <- mem_data_all_r %>% 
  ggplot(aes(y = tti, 
             x = mpa_scaled, 
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = tti.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
...
fh_plot <- mem_data_all_r %>% 
  ggplot(aes(y = fh, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = fh.mpa.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
       y = "Flame Height (cm)") 
...
fh_plot_lfm <- mem_data_all_r %>% 
  ggplot(aes(y = fh, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = fh.lfm.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
       y = "Flame Height (cm)") 
...
gd_plot <- mem_data_all_r %>% 
  ggplot(aes(y = gd, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = gd.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
       y = "Glow Duration (sec)") 
...
fd_plot <- mem_data_all_r %>% 
  ggplot(aes(y = fd, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = fd.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
...
fd_plot_r <- mem_data_all_r %>% 
  ...
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = fd.sig)) + 
  color_many  + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title.x = element_text(size = 18, face = 'bold'), axis.title.y = element_text(size = 22, face = 'bold'))+
...
temp_change_plot <- mem_data_all_r %>% 
  ggplot(aes(y = temp_change, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = temp.change.sig)) + 
  color_many + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold'))+
  labs(x = "", 
       y = "Temp Change (C)") 
temp_change_plot
...
prop_ignite_plot <- mem_data_all_r %>% 
  ggplot(aes(y = prop_ignite, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = prop.ig.mpa.sig)) + 
  color_many + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold')) +
  labs(x = "", 
...
prop_ignite_plot_lfm <- mem_data_all_r %>% 
  ggplot(aes(y = prop_ignite, 
             ...
             group = spp)) +
  geom_point(alpha= .6, aes(color = spp))+
  geom_smooth(method = "lm", se = F, aes(color = spp, lty = prop.ig.lfm.sig)) + 
  color_many + theme(legend.position = "none",                                   axis.text = element_text(size = 14), axis.title = element_text(size = 22, face = 'bold')) +
  labs(x = "", 
       y = "Proportion Ignited (%)") 
prop_ignite_plot
