...
tti_plot_lfm_r <- mem_data_all_r %>%
  ...
  annotate(geom = "text", x = -2.6, y = 215, label = 'a', fontface = 'bold', size = 10)
tti_plot_lfm_r
...
lower_temp_max_plot_lfm_r <- mem_data_all_r %>% 
  ...
  annotate(geom = 'text', x = 2.8, y = 170, label = 'wet', size = 5) +
  geom_segment(aes(x = -2, y = 170, xend = 2.5, yend = 170),
...
tab_model(tti_mod_fgroup, fh_mod_fgroup, gd_mod_fgroup,lower_temp_max_mod_fgroup,
        ...
        dv.labels = c("Time to Ignition", "Flame Height","Glow Duration", "Max Temp"),
...
plot_model(tti_mod, 
                  # type = "slope",
                   rm.terms = c("site", "year_month", "sample_wt_scaled", "year month [2020_september]"), 
                   show.p = TRUE)
...
tti.ES.lfm <- c(13, 3.3, 14, 18, 4.8) # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
tti.SE.lfm <- c(3.372, 6.845, 5.582, 5.131, 7.569)
tti.sig.lfm <- c('Yes', 'No', 'No', 'Yes', 'No')
tti.ES.mpa <- c(19,1.2, 16, 4.3, 3.9) 
...
tti.ES.lfm.plot <- ggplot(data = tti.ES.df, aes(x = species, y = tti.ES.lfm, 
 ...
 # geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  theme_bw() +
  scale_y_continuous(limits = c(-12.5, 28), breaks = c(-10,-5, 0, 5, 10, 15, 20)) +
  color_noceco+
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 25, label = 'b', fontface = 'bold', size = 10) +
...
tti.ES.mpa.plot <- ggplot(data = tti.ES.df, aes(x = species, y = tti.ES.mpa,
 ...
 # geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  ...
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 25, label = 'c', fontface = 'bold', size = 10) +
 # annotate(geom = "text", x = 2, y = 14, label = 'Gymnosperms', size = 4) +
 # annotate(geom = "text", x = 4.52, y = 14, label = 'Angiosperms', size = 4) +
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(),
...
fh.ES.lfm <- c(-0.57, -0.33, -1.4, 1.1, -1.8) # Following this order: ABCO, CADE, PIJE, ARPA, QUKE
fh.SE.lfm <- c(0.96460, 1.95516, 1.59944, 1.47320, 2.16010)
fh.sig.lfm <- c('Yes', 'No', 'No', 'Yes', 'No')
fh.ES.mpa <- c(2.1, -1.7, 0.085, -0.53, -1.1) 
...
fh.ES.lfm.plot <- ggplot(data = fh.ES.df, aes(x = species, y = fh.ES.lfm, 
 ...
 # geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  theme_bw() +
  scale_y_continuous(limits = c(-5.5, 4.25), breaks = c(-5,-2.5, 0, 2.5)) +
  #color_many2 +
  color_noceco+
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 3.65, label = 'e', fontface = 'bold', size = 10) +
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(),
        axis.title.y = element_blank(), 
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
fh.ES.mpa.plot <- ggplot(data = fh.ES.df, aes(x = species, y = fh.ES.mpa,
 ...
 # geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  ...
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 3.65, label = 'f', fontface = 'bold', size = 10) +
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(),
        axis.title.y.right = element_text(face = 'bold', size = 14),
        axis.ticks.y.left = element_blank(), 
        axis.text.y.left = element_blank(),
...
temp_max.ES.lfm <- c(1.1, 3.4, 17, 9.6, -19) # Following this order: ABCO, CADE, PIJE, ARPA, QUKE
temp_max.SE.lfm <- c(6.4496, 13.2046, 10.4746, 9.5420, 14.7575)
temp_max.sig.lfm <- c('No', 'No', 'No', 'No', 'No')
temp_max.ES.mpa <- c(2.9, 1.5, 27, 20, -14)
...
temp_max.ES.lfm.plot <- ggplot(data = temp_max.ES.df, aes(x = species, y = temp_max.ES.lfm, 
  ...
  #geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  theme_bw() +
  scale_y_continuous(limits = c(-27, 37), breaks = c(-15, 0, 15, 30)) +
  #color_many2 +
  color_noceco+
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 32, label = 'h', fontface = 'bold', size = 10) +
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(),
        axis.title.y = element_blank(), 
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
temp_max.ES.mpa.plot <- ggplot(data = temp_max.ES.df, aes(x = species, y = temp_max.ES.mpa,
  ...
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
  annotate(geom = "text", x = 0.9, y = 32, label = 'i', fontface = 'bold', size = 10) +
  theme(axis.title.x = element_blank(), axis.text.x = element_blank(),
        axis.ticks.y.left = element_blank(), 
        axis.text.y.left = element_blank(),
        axis.title.y.right = element_text(face = 'bold', size = 14),
...
gd.ES.lfm <- c(11, 5.5, 7.1, 15, -17) # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
gd.sig.lfm <- c('No', 'No', 'No', 'No', 'Yes')
gd.SE.lfm <- c(9.380, 19.206, 15.175, 13.822, 21.512)
gd.ES.mpa <- c(-3.6, 2.7, 12, 7.2, -7)
gd.sig.mpa <- c('Yes', 'No', 'No', 'No', 'Yes')
gd.SE.mpa <- c(16.026, 22.647, 21.498, 18.889, 21.503)
...
gd.ES.lfm.plot <- ggplot(data = gd.ES.df, aes(x = species, y = gd.ES.lfm, 
 ...
 # geom_vline(xintercept = 3.4, alpha = 0.5, size = 0.3, lty = 2) +
  theme_bw() +
  scale_y_continuous(limits = c(-29, 30), breaks = c(-20 ,-10, 0, 10, 20)) +
  #color_many2 +
  color_noceco+
  #scale_color_manual(values = c('black', '#FDD358', 'black', 'black', '#FDD358')) + # For color by angio vs gymno (version 1)
  scale_shape_manual(values = c(10, 16)) +
...
gd.ES.mpa.plot <- ggplot(data = gd.ES.df, aes(x = species, y = gd.ES.mpa,
  ...
  labs(y = '', color = 'Species', shape = 'Significant?', title = "MPa") +
  scale_y_continuous(limits = c(-29, 30), breaks = c(-20, -10, 0, 10, 20),
                     sec.axis = sec_axis(trans = ~.*1, 
                     name = ' ',
                     breaks = c(-20, -10, 0, 10, 20),
...
ggarrange(gd_plot_lfm_r, gd.ES.lfm.plot, gd.ES.mpa.plot, ncol = 1)
```
