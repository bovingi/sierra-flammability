...
tti_mod.lfm <- lmer(tti ~ spp*lfm_scaled + site + year_month + sample_wt_scaled + (1 | individual), data = mem_data_all_r)
tti_mod.mpa <- lmer(tti ~ spp*mpa_scaled + site + year_month + sample_wt_scaled + (1 | individual), data = mem_data_all_r)
...
tti.ES.lfm <- c(tti_mod.coef.df$estimate[6], tti_mod.coef.df$estimate[11:12], tti_mod.coef.df$estimate[10], tti_mod.coef.df$estimate[13])
...
tti.ES.mpa <- c(tti_mod.coef.df$estimate[21], tti_mod.coef.df$estimate[26:27], tti_mod.coef.df$estimate[25], tti_mod.coef.df$estimate[28]) 
...
tti.ES.lfm.plot <- ES.plot(tti.ES.df, tti.ES.lfm, tti.sig.lfm, tti.SE.lfm,
                           ...
                           limits.vector = c(-17, 19),
                           breaks.vector = c(-15, -10, -5, 0, 5, 10, 15)) +
  annotate(geom = "text", x = 0.7, y = 17, label = 'd',
...
tti.ES.mpa.plot <- ES.plot(tti.ES.df, tti.ES.mpa, tti.sig.mpa, tti.SE.mpa,
                           mpa = 'y',
                           margins.vector = c(0.2, 0.2, 0.1, 0),
                           limits.vector = c(-17, 19),
                           breaks.vector = c(-15, -10, -5, 0, 5, 10, 15)) +
  annotate(geom = "text", x = 0.7, y = 17, label = 'g',
           fontface = 'bold', size = 10) +
...
Setup:
```{r}
fh.ES.lfm <- c(fh_mod.coef.df$estimate[6], fh_mod.coef.df$estimate[11:12], fh_mod.coef.df$estimate[10], fh_mod.coef.df$estimate[13])
  # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
...
fh.ES.mpa <- c(fh_mod.coef.df$estimate[21], fh_mod.coef.df$estimate[26:27], fh_mod.coef.df$estimate[25], fh_mod.coef.df$estimate[28]) 
...
Setup:
```{r}
temp_max.ES.lfm <- c(temp_mod.coef.df$estimate[6], temp_mod.coef.df$estimate[11:12], temp_mod.coef.df$estimate[10], temp_mod.coef.df$estimate[13])
  # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
...
temp_max.ES.mpa <- c(temp_mod.coef.df$estimate[21], temp_mod.coef.df$estimate[26:27], temp_mod.coef.df$estimate[25], temp_mod.coef.df$estimate[28]) 
...
temp_max.ES.lfm.plot <- ES.plot(temp_max.ES.df, temp_max.ES.lfm, temp_max.sig.lfm, temp_max.SE.lfm,
  ...
  annotate(geom = "text", x = 0.7, y = 23.3, label = 'f',
           fontface = 'bold', size = 10)
...
temp_max.ES.mpa.plot <- ES.plot(temp_max.ES.df, temp_max.ES.mpa, temp_max.sig.mpa, temp_max.SE.mpa,
                          ...
                          limits.vector = c(-27, 27),
                          breaks.vector = c(-25, -12, 0, 12, 25)) +
  annotate(geom = "text", x = 0.7, y = 23.3, label = 'i',
           fontface = 'bold', size = 10)
...
Setup:
```{r}
gd.ES.lfm <- c(gd_mod.coef.df$estimate[6], gd_mod.coef.df$estimate[11:12], gd_mod.coef.df$estimate[10], gd_mod.coef.df$estimate[13])
  # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
...
gd.ES.mpa <- c(gd_mod.coef.df$estimate[21], gd_mod.coef.df$estimate[26:27], gd_mod.coef.df$estimate[25], gd_mod.coef.df$estimate[28]) 
...
gd.ES.lfm.plot <- ES.plot(gd.ES.df, gd.ES.lfm, gd.sig.lfm, gd.SE.lfm,
                           margins.vector = c(0.1, 0.05, 0.1, 0.1),
                           limits.vector = c(-25, 25),
                           breaks.vector = c(-20, -10, 0, 10, 20)) +
  labs(title = 'LFM')
...
Setup:
```{r}
fd.ES.lfm <- c(fd_mod.coef.df$estimate[6], fd_mod.coef.df$estimate[11:12], fd_mod.coef.df$estimate[10], fd_mod.coef.df$estimate[13])
  # Following this order: ABCO, CADE, PIJE, ARPA, QUKE (no CECO)
...
fd.ES.mpa <- c(fd_mod.coef.df$estimate[21], fd_mod.coef.df$estimate[26:27], fd_mod.coef.df$estimate[25], fd_mod.coef.df$estimate[28]) 
