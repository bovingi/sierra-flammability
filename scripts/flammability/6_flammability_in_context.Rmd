...
#Data: 
```{r}
field_data_all_6_raw <- read_csv(here("processed-data", "analysis 2.0", "field_data_2020_2021.csv")) 
...
field_data_all_6$spp <- factor(field_data_all_6$spp, levels = c("abco", "pije", "cade", "arpa", "quke"))
 ...
 mem_data_all_6 <- read_csv(here("processed-data", "analysis 2.0","mem_final_from5.05.csv"))
...
ggsave(here('figures', 'predicted.flam.from.field.V2.jpg'), height = 15, width = 8.5)
```
