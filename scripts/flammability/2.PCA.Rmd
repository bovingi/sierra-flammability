...
sierra_flamdata_pca <- sierra_flamdata_pca_all %>% 
  filter(ignition == 1, 
   ...
   select("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","temp_change", "hydration", "spp", "year_month", "sample") %>% 
...
figure_epi_pca_cat <-  (sierra_flamdata_pca[, c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","temp_change", "hydration", "spp", "year_month", "sample")]) %>% 
  na.omit() %>% 
...
figure_epi_pca <- (sierra_flamdata_pca[, c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","temp_change", "hydration", "spp", "year_month", "sample")]) %>% 
  na.omit() 
```
