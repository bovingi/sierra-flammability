...
sierra_flamdata_pca <- sierra_flamdata_pca_all %>% 
  filter(ignition == 1, 
         ignition_num == 1) %>% 
  na.omit(c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","taller_temp_max", "hydration", "spp", "year_month", "sample"))

 # filter(year == 2020)

figure_epi_pca_quant <- (sierra_flamdata_pca[, c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","taller_temp_max")]) %>%  
...
figure_epi_pca_cat <-  (sierra_flamdata_pca[, c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","taller_temp_max", "hydration", "spp", "year_month", "sample")]) %>% 
  na.omit() %>% 
  select(hydration, spp, year_month, sample) %>% 
...
figure_epi_pca <- (sierra_flamdata_pca[, c("fh", "ttfg", "tti", "fd", "gd", "gti", "pfg","taller_temp_max", "hydration", "spp", "year_month", "sample")]) %>% 
  na.omit() 
```
...
sierra_flamdata_pca_noignitions <- sierra_flamdata_pca %>%
