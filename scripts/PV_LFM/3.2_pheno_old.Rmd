...
p2 <- ggplot2::ggplot(data = df3, aes(x = date, y = lfm, color = phenophase_name)) +
  ...
  scale_color_manual(values = c("lightblue", "darkslategray4", "darkred")) +
...
legend.plot <- ggplot() +
  ...
  labs(color = "Phenophase") +
  scale_color_manual(values = c("lightblue", "lightgreen", "darkslategray4", "gold", "brown", "darkred", "deeppink")) + #Holder color palette, matched to the phenophase vector above
...
pije.colors <- c("darkslategray4", "lightgreen")
