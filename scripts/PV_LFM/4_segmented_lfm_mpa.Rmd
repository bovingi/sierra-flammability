...
#   #geom_vline(xintercept  = field_data$mean_tlp_spp, colour = "blue") +
...
```{r,warning=FALSE}
pv_all_df_4 <- read_csv(here("processed-data", "analysis 2.0", "all_pv_curves_clean_v2.csv"), show_col_types = FALSE) %>%
  mutate(spp == species) %>% 
