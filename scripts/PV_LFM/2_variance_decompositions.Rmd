...
```{r}
m1 <- lmer(maxLFM ~ spp * year_month + (1|plant), data = pv_all_df) 
...
m3 <- lmer(maxLFM ~ year_month + (1|plant), data = pv_all_df)
...
mod_all_df <- mod_all_df1 %>% 
  ...
  mutate(
    ...
    time_effect = m2, #week + mpa mod - mpa mod
         spp_effect = m3, #week + mpa mod - week mod
...
mod_all_df <- mod_all_df1 %>% 
  ...
  mutate(
    #spp_AND_time_effects =  m3 - week_effect - mpa_effect,
    time_effect = m3, #week + mpa mod - mpa mod
         spp_effect = m2, #week + mpa mod - week mod
         full_mod = m1, #week + mpa mod 
    spp_AND_time_effects =  m1 - m2 - m3,
         ) #full minus the effects of mpa and week alone
mod_all_df
