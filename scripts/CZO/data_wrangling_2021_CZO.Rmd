...
data_with_na_czo <- raw_data_czo %>% 
  ...
  replace_with_na(replace = list(temp_at_ignition_lower = c(0, 0.0))) %>% #for missing temp at ignition, make NA (all 2016 & 2018 trials)
  replace_with_na(replace = list(temp_at_ignition_teller = c(0, 0.0))) %>% #for missing temp at ignition, make NA (all 2016 & 2018 trials)
