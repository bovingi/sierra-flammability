---
title: 'Data Wrangling: czo Flam. Curves'
author: "Indra Boving"
date: "2/19/2021"
...
write.csv(rwc.data, here("processed-data/czo.flam.curve.physiological.data.csv"))
...
ignite.only.hp <- ignite.only.hp %>%
  mutate(flam.index = .45*((387+tti)/(12.5+tti))*exp(fh/(fh+55))) #using max tti and max fh, becomes a scale of least (1) to most (20) flammable
...
write.csv(x = hp.ignite.only.pca, (here("processed-data", "analysis 2.0", "czo_flam_data_all.csv")))
```
