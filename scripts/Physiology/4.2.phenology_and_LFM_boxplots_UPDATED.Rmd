...
cade.phenophases <- c("Pollen cones", "Pollen release")
cade.colors <- c("#6B91BD", "#E69512")
p.cade <- pheno.dotplot.vis(species = "CADE", phenophases = cade.phenophases, colors = cade.colors, letter = 'c')

ceco.phenophases <- c("Flowers or flower buds", "Ripe fruits", "Young leaves")
ceco.colors <- c("#F03D79", "#070093", "#52E764")
p.ceco <- pheno.dotplot.vis(species = "CECO", phenophases = ceco.phenophases, colors = ceco.colors, no.phenophases = three, letter = 'd')

arpa.phenophases <- c("Breaking buds", "Flowers or flower buds", "Ripe fruits", "Young leaves")
arpa.colors <- c("#4ECDC4", "#F03D79", "#070093", "#52E764")
p.arpa <-pheno.dotplot.vis(species = "ARPA", phenophases = arpa.phenophases, colors = arpa.colors, no.phenophases = four, letter = 'e')

quke.phenophases <- c("Breaking buds", "Increasing leaf size", "Ripe fruits")
quke.colors <- c("#4ECDC4", "#2B3E37", "#070093")
p.quke <- pheno.dotplot.vis(species = "QUKE", phenophases = quke.phenophases, colors = quke.colors, no.phenophases = three, letter = 'f')
