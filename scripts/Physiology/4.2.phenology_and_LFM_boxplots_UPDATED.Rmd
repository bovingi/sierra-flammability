...
p1 <- ggplot(data = old_lfm_df) +
  geom_point(aes(y = value, x = month), data = old_lfm_df, color = '#262E43', size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = old_lfm_df, color = '#262E43') +
  geom_point(aes(y = value, x = month), data = new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2), shape = 1, size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2)) +
  geom_point(aes(y = value*coef, x = month), data = mpa_df, color = '#5792CC', position = position_nudge(x = 0.2), size = 5) +
  geom_linerange(aes(x = month, ymin = value*coef - 2*sd*coef, ymax = value*coef + 2*sd*coef), data = mpa_df, color = '#5792CC', position = position_nudge(x = 0.2)) +
  geom_hline(aes(yintercept  = mean_lfm),
...
p1 <- ggplot(data = quke_old_lfm_df) +
  geom_point(aes(y = value, x = month), data = quke_old_lfm_df, color = '#262E43', size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = quke_old_lfm_df, color = '#262E43') +
  geom_point(aes(y = value, x = month), data = quke_new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2), shape = 1, size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = quke_new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2)) +
  geom_point(aes(y = value*coef, x = month), data = quke_mpa_df, color = '#5792CC', position = position_nudge(x = 0.2), size = 5) +
  geom_linerange(aes(x = month, ymin = value*coef - 2*sd*coef, ymax = value*coef + 2*sd*coef), data = quke_mpa_df, color = '#5792CC', position = position_nudge(x = 0.2)) +
  geom_hline(aes(yintercept  = mean_lfm),
             linetype = "dashed", color = '#262E43') +
  geom_hline(aes(yintercept  = mean_mpa_plot),
             linetype = "dashed", color = '#5792CC') +
...
p1 <- ggplot(data = pije_old_lfm_df) +
  geom_point(aes(y = value, x = month), data = pije_old_lfm_df, color = '#262E43', size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = pije_old_lfm_df, color = '#262E43') +
  geom_point(aes(y = value, x = month), data = pije_new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2), shape = 1, size = 5) +
  geom_linerange(aes(x = month, ymin = value - 2*sd, ymax = value + 2*sd), data = pije_new_lfm_df, color = '#262E43', position = position_nudge(x = -0.2)) +
  geom_point(aes(y = value*coef, x = month), data = pije_mpa_df, color = '#5792CC', position = position_nudge(x = 0.2), size = 5) +
  geom_linerange(aes(x = month, ymin = value*coef - 2*sd*coef, ymax = value*coef + 2*sd*coef), data = pije_mpa_df, color = '#5792CC', position = position_nudge(x = 0.2)) +
  geom_hline(aes(yintercept  = mean_lfm),
             linetype = "dashed", color = '#262E43') +
  geom_hline(aes(yintercept  = mean_mpa_plot),
             linetype = "dashed", color = '#5792CC') +
...
dots.spp.w.grob <- gridExtra::grid.arrange(arrangeGrob(p.spp, left = y.grob, right = y.grob2))
