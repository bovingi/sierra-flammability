...
df2 %>% 
  ggplot() +
  geom_point(aes(color = name, y = value, x = month)) +
  geom_linerange(aes(x = month, ymin = value - sd, ymax = value + sd, color = name)) +
  scale_fill_manual(values = c('#B2BEB5', '#36454F', 'black')) +
