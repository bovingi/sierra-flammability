...
pv_plot_angio <- lfm.vs.mpa.scatterplot(f.group = "Angiosperm", y.lab = "PV Curves", y.axis = T, y.max = 250, df = pv_plot_df) +
  annotate(geom = "text", x = 0.5, y = 230, label = 'c', fontface = 'bold', size = 20)
pv_plot_angio
...
pv_plot_gymno <- lfm.vs.mpa.scatterplot(f.group = "Gymnosperm", y.max = 250, df = pv_plot_df) +
  annotate(geom = "text", x = 0.5, y = 230, label = 'd', fontface = 'bold', size = 20)
pv_plot_gymno
...
flam_plot_angio <- lfm.vs.mpa.scatterplot(f.group = "Angiosperm", y.lab = "Flam. Data", y.axis = T, y.max = 250, x.axis = T, df = flam_all_df) +
  annotate(geom = "text", x = 0.5, y = 230, label = 'e', fontface = 'bold', size = 20)
flam_plot_angio
...
flam_plot_gymno <- lfm.vs.mpa.scatterplot(f.group = "Gymnosperm", y.max = 250, x.axis = T, df = flam_all_df) +
  annotate(geom = "text", x = 0.5, y = 230, label = 'f', fontface = 'bold', size = 20)
flam_plot_gymno
...
ggsave(plot=plots_legend, bg = "white" , here("figures", "main-figures", "Fig5.LFM.vs.MPa.Scatterplots.jpg"), height = 10.5, width = 14)
```
...
ggsave(plot=pv_vardecomp_gymno, bg = "white" , here::here("figures",  "extra-figures", "var_decomp", "all_vardecomp"), device="jpg")
```
